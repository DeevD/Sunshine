...
import com.example.heinhtet.sunshine.R;
...
public final class SunshinePreferences {
    ...
    public static String getPreferredBackgroundColor(Context context) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);

        String keyForColor = context.getString(R.string.pref_color_key);
        String defaultColor = context.getString(R.string.pref_color_red_value);

        return sp.getString(keyForColor,defaultColor);
    }

    public static boolean isShown(Context context)
    {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean show = sharedPreferences.getBoolean(context.getString(R.string.bool),context.getResources().getBoolean(R.bool.default_key_bool));

        return show;
    }

    public static boolean isMMLanguage(Context context)
    {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean showMM = sharedPreferences.getBoolean(context.getString(R.string.language_mm),context.getResources().getBoolean(R.bool.default_key_bool));
        return showMM;
    }
