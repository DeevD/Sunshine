...
//      COMPLETED (3) Within syncWeather, fetch new weather data
        ...
        try {
            ...
            String weatherLocation = SunshinePreferences.getPreferredWeatherLocation(context);
//            URL weatherRequestUrl = NetworkUtils.buildUrlWithLocationQuery(weatherLocation);
            URL fun_udacity = NetworkUtils.getUrl(context);
//            Log.d("Change Url ", weatherRequestUrl.toString());
            Log.d("Change Url ", fun_udacity.toString());




            /* Use the URL to retrieve the JSON */
            String jsonWeatherResponse = NetworkUtils.getResponseFromHttpUrl(fun_udacity);
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                /* Get a handle on the ContentResolver to delete and e data */
                ContentResolver sunshineContentResolver = context.getContentResolver();

//              COMPLETED (4) If we have valid results, delete the old data and insert the new
                /* Delete old weather data because we don't need to keep multiple days' data */
                sunshineContentResolver.delete(
                        WeatherContract.WeatherEntry.CONTENT_URL,
                        null,
                        null);
