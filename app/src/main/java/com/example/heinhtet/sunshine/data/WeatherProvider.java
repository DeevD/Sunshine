...
/**
 * Created by heinhtet on 4/23/17.
 */

public class WeatherProvider extends ContentProvider {
    WeatherDBHelper mOpenHelper;
    public static final int CODE_WEATHER = 100;
    public static final int CODE_WEATHER_WITH_DAY  = 101;
    ...
    public static final UriMatcher buildUriMatcher()
    {
        ...
        matcher.addURI(authority, WeatherContract.PATH_WATHER,CODE_WEATHER);
        matcher.addURI(authority,WeatherContract.PATH_WATHER+"/#",CODE_WEATHER_WITH_DAY);
