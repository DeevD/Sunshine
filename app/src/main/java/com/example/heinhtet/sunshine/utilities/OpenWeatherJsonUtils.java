 ...
 */
package com.example.heinhtet.sunshine.utilities;
...
public final class OpenWeatherJsonUtils {
    ...
    public static String[] getSimpleWeatherStringsFromJson(Context context, String forecastJsonStr)
        ...
        for (int i = 0; i < weatherArray.length(); i++) {
            ...
            int iv = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
...
//            windDirection = dayForecast.getDouble(OWM_WIND_DIRECTION);
            ...
            double mPressure = main.getDouble("pressure");
            double max = main.getDouble("temp_max");
            double min = main.getDouble("temp_min");
            int mhumidity  = main.getInt("humidity");



            JSONObject mwindSpeed = dayForecast.getJSONObject("wind");
            double speed = mwindSpeed.getDouble("speed");
            double degree = mwindSpeed.getDouble("deg");
...
//            low = temperatureObject.getDouble(OWM_MIN);
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_HUMIDITY, mhumidity);
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_PRESSURE, mPressure);
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, speed);
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_DEGREE, degree);
