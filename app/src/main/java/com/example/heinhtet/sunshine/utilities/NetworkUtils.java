...
public final class NetworkUtils {
    ...
    public static final String wealther = "http://api.openweathermap.org/data/2.5/forecast";

    private static final String FORECAST_BASE_URL = STATIC_WEATHER_URL;
    private static final String appID = "e5595d5016d39a34458c6c67d6974696";
    /*
...
//        }
        String loactionQuery = SunshinePreferences.getPreferredWeatherLocation(context);
        return buildUrlWithLocationQuery(loactionQuery);
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(DYNAMIC_WEATHER_URL).buildUpon()
    ...
    public static URL buildUrlWithLocationQuery(String locationQuery) {
        Uri weatherQueryUri = Uri.parse(wealther).buildUpon()
